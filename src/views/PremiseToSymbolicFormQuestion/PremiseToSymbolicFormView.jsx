...
import styles from '../../assets/views/jss/PremiseToSymbolicFormQuestion/premise_to_symbolic_form_view';
...
export default withStyles(styles)(PremiseToSymbolicFormView);
